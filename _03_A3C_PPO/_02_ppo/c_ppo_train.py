...
from b_actor_and_critic import Actor, Buffer, Critic, Transition
...
class PPO:
    def __init__(self, config: dict, use_wandb: bool):
        ...
        self.global_actor = Actor(config["n_features"], config["n_actions"]).share_memory()
        self.global_critic = Critic(config["n_features"]).share_memory()
